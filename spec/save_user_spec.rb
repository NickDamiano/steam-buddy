RSpec.describe SaveUser do 
  describe '.save_user' do 
    ...
    it 'should return a string when passed an xml file' do 
      cdata = "![CDATA[ goat[yusef] ]]"
      result = SaveUser.parse_cdata_value(cdata)

      expect(result).to include('goat[yusef]')
    end
    ...
    it 'should save a new user into the database' do
      ...
      new_info['profile']['steamID']          = "![CDATA[ goat[yusef] ]]"
      new_info['profile']['avatarIcon']       = '![CDATA[ http://cdn.akamai.steamstatic.com/steamcommunity/public/images/avatars/de/de0447b6d0b23d766f804e0923706a8642b5fc3d.jpg ]]'
      new_info['profile']['vacBanned']         = 1
      new_info['profile']['customURL']          = '![CDATA[ youda ]]'
      new_info['profile']['memberSince']      = "December 24, 2007"
      new_info['profile']['location']         = '![CDATA[ Austin, Texas, United States ]]'
      new_info['profile']['realname']          = '![CDATA[ Yusef ]]'
      new_info["profile"]["groups"]['group'].first["groupID64"] = 103582791434636960
      new_info["profile"]["groups"]['group'].first["groupName"] = '![CDATA[ Steam Family Sharing ]]'
    ...
    it 'should update existing user in the database' do
      ...
      new_info['profile']['steamID']          = "![CDATA[ goat[yusef] the cs hacker ]]"
      new_info['profile']['avatarIcon']       = '![CDATA[ http://cdn.akamai.steamstatic.com/steamcommunity/public/images/avatars/de/de0447b6d0b23d766f804e0923706a8642b5fc3d.jpg ]]'
      new_info['profile']['vacBanned']         = 1
      new_info['profile']['customURL']          = '![CDATA[ youda ]]'
      new_info['profile']['memberSince']      = "December 24, 2007"
